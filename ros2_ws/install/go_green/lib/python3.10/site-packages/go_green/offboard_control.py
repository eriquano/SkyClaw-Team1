...
class OffboardControl(Node):
    ...
    def __init__(self) -> None:
        ...
        self.camera_subscriber = self.create_subscription(
            Image, '/iris/bottom_camera/bottom_camera/image_raw', self.image_callback, qos_profile=qos_profile_sensor_data)
    ...
    def disarm(self):
        ...
        self.publish_vehicle_command(
            VehicleCommand.VEHICLE_CMD_COMPONENT_ARM_DISARM, param1=0.0, param2=0.0)
